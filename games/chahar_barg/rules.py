...
def _find_number_combos(
    ...
    همه ترکیب‌ها برگردانده می‌شوند تا بازیکن خودش
...
def resolve_move(
    ...
    # سیستم همان ترکیب را خودکار برمی‌دارد.
    # =========================================================
    ...
    # =========================================================
    # چند ترکیب برای ۱۱ وجود دارد.
    #
    # سیستم نباید انتخاب کند.
    # بازیکن باید خودش انتخاب کند.
    # =========================================================
...
def count_clubs(
    ...
    """
    تعداد کارت‌های گشنیز جمع‌شده توسط بازیکن.

    در دسته استاندارد ۵۲تایی دقیقاً ۱۳ کارت گشنیز وجود دارد.

    هفت‌خاج به این شکل محاسبه می‌شود:
    بازیکنی که تعداد بیشتری کارت گشنیز جمع کرده باشد،
    ۷ امتیاز دریافت می‌کند.
