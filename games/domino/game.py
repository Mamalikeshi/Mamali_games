...
class DominoGame:
    ...
    # =========================================================
    # ترکِ عمدیِ بازی (وقتی بازیکن به‌جای ادامه، بازیِ جدید
    # می‌زنه و بازیِ فعلی رو رها می‌کنه)
    # =========================================================

    def forfeit_by(self, user_id: int) -> bool:
        ...
        self.forfeit = True
        self.forfeit_reason = "opponent_left"
